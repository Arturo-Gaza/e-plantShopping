...
function ProductList({ onHomeClick }) {
    ...
    // Obtener el carrito desde redux para mostrar la cantidad total de items
    const cartItems = useSelector(state => state.cart.items); // Asumiendo que el slice se llama cart y tiene items
